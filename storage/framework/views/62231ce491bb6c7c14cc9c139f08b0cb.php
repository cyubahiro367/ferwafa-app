                            ...
                            <div class="table-responsive">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card-body">
                                            <form method="POST"
                                                action="<?php echo e(route('create.game', [request()->route('divisionID'), request()->route('categoryID')])); ?>"
                                                enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>

                                                <?php if(request()->route('divisionID') == 2): ?>
...
<?php /**PATH /home/ferwafa/public_html/resources/views/admin/create-game.blade.php ENDPATH**/ ?>