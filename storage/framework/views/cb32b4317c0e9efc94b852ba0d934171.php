        ...
        <div class="container">
            ...
            <div class="footer-about">
                <div class="logo-block">
                    <img src="<?php echo e(asset('asset/images/file.png')); ?>" alt="logo" width="150" height="150" />
                </div>
                <div class="footer-about-content">
                    <h3 class="block-title">About Ferwafa</h3>
                    <p>
                        The Fédération Rwandaise de Football Association (FERWAFA) was established in 1972 and became affiliated with both the Confederation  Africaine de Football (CAF) and the Fédération Internationale de Football Association (FIFA) in 1978.

FERWAFA operates in full alignment with the statutes and regulations of FIFA and CAF, ensuring that its own members adhere to its statutes, as well as to the directives and decisions issued by the above governing bodies.

Guided by its motto “Unity, Discipline, and Victory”, FERWAFA is committed to promoting the development, integrity, and excellence of Football in Rwanda, fostering both sporting and ethical standards at all levels of the game.
                    </p>
                </div>
            </div>
            <!-- Footer About /- -->
                    ...
                    <div class="contactinfo-box">
                        ...
                        <div class="contactinfo-box">
                            ...
                            <p style="margin-left: 25px">
                                <a href="mailto:sgoffice@ferwafa.com" title="sgoffice@ferwafa.com">sgoffice@ferwafa.com</a>
                            </p>
                        </div>
                </aside>
                <!-- ContactUs Widget /- -->
    ...
    <!-- Library - Js -->
    <script src="<?php echo e(asset('libraries/lib.js')); ?>"></script>
    <!-- Bootstrap JS File v3.3.5 -->
    <script src="<?php echo e(asset('libraries/jquery.countdown.min.js')); ?>"></script>

    <script src="<?php echo e(asset('libraries/lightslider-master/lightslider.js')); ?>"></script>
    <!-- Library - Google Map API -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCn3Z6i1AYolP3Y2SGis5qhbhRwmxxo1wU"></script>
    <script src="<?php echo e(asset('js/functions.js')); ?>"></script>
</body>
<?php /**PATH /home/ferwafa/public_html/resources/views/footer.blade.php ENDPATH**/ ?>