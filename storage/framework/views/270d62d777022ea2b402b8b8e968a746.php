    ...
    <div id="slider-section" class="slider-section container-fluid no-padding">
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" role="listbox">
                <?php $__currentLoopData = $topResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $topResult): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($topResult['is_top'] == 1): ?>
                        <?php if($key === 0): ?>
                            <div class="item active">
                            <?php else: ?>
                                <div class="item">
                        <?php endif; ?>
                        <img src="<?php echo e(route('news.images.show', $topResult['image_url'])); ?>" alt="slide1"
                                    ...
                                    <div class="slider-content-box">
                                        <div class="col-md-12 col-sm-12 col-xs-6 no-padding">
                                            <h3 class="slider-title">
                                                <?php echo e($topResult['title']); ?>

                                            </h3>
                                            <span>January 03-07</span>
                                            <p>
                                                <?php echo e($topResult['caption']); ?>

                                            </p>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-6 no-padding">
                                            <a href="<?php echo e(route('single.news', $topResult['id'])); ?>"
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <article class="type-post">
                                        <div class="entry-cover">
                                            <a href="<?php echo e(route('single.news', $news['id'])); ?>"><img
                                        ...
                                        <div class="entry-block">
                                            ...
                                            <div class="entry-meta">
                                                <div class="post-date">
                                                    <a href="#" title=""><i class="fa fa-calendar"
                                                            aria-hidden="true"></i><span><?php echo e(date('jS M Y', strtotime($news['created_at']))); ?>
                                            ...
                                            <a href="<?php echo e(route('single.news', $news['id'])); ?>" class="learn-more"
                            ...
                            <div class="howwecan-right">
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="howwecan_3">
                                        <a href="<?php echo e(route('all.news')); ?>" title="Read More">Read More News</a>
                                    </div>
                                </div>
                            </div>
                        </center>
                            ...
                            <div class="testimonial-carousel-left">
                                <div class="testimonial-box testimonial-left" style="height: 136px">
                                    <a href="https://www.minisports.gov.rw/" target="_blank">
                                        <img src="<?php echo e(asset('images/images.jpeg')); ?>" alt="testimonial1"
                                ...
                                <div class="testimonial-box testimonial-left" style="height: 136px">
                                    <a href="https://olympicrwanda.org/" target="_blank">
                                        <img src="<?php echo e(asset('images/Logo Institu CNOSR sans fond.png')); ?>"
                                            alt="testimonial1" style="width: 144px; height: 136px" />
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-5 no-padding">
                            <div class="testimonial-carousel-right">
                                <div class="testimonial-box testimonial-right" style="height: 136px">
                                    <a href="https://olympicrwanda.org/" target="_blank">
                                        <img src="<?php echo e(asset('images/Logo Institu CNOSR sans fond.png')); ?>" alt="testimonial1"
                                            style="width: 144px; height: 136px" />
                                    </a>
                                </div>
                                <div class="testimonial-box testimonial-right" style="height: 136px">
                                    <a href="https://www.fifa.com/fifaplus/en" target="_blank">
                                        <img src="<?php echo e(asset('images/fifa.png')); ?>" alt="testimonial1"
...
<?php /**PATH /home/ferwafa/public_html/resources/views/homePage.blade.php ENDPATH**/ ?>