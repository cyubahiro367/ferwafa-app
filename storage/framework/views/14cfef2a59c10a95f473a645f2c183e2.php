                ...
                <div class="col-12">
                    <div style="height: 90%" class="card">
                        <div class="card-header">
                            <h4>Create Top Score <?php echo e(request()->route('categoryID')); ?></h4>
                        </div>
                            ...
                            <div class="table-responsive">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card-body">
                                            <form method="POST"
                                                action="<?php echo e(route('create.top-score', [request()->route('divisionID'), request()->route('categoryID')])); ?>"
...
<?php /**PATH /home/ferwafa/public_html/resources/views/admin/create-topScore.blade.php ENDPATH**/ ?>