                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="<?php echo e(route('post.news')); ?>" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
...
</body><?php /**PATH /home/ferwafa/public_html/resources/views/admin/create-news.blade.php ENDPATH**/ ?>