...
@section('content')
    ...
    <div class="fw-admin-panel">
        <div class="fw-admin-panel-body fw-admin-form">
            <form method="POST" action="" enctype="multipart/form-data" class="fw-admin-submit-guard">
                @csrf
                @method('PUT')
                ...
                <div class="fw-admin-form-group">
                    ...
                    <input type="number" name="homeTeamGoals" id="homeTeamGoals" class="fw-admin-form-control">
                    @error('homeTeamGoals')
                ...
                <div class="fw-admin-form-group">
                    ...
                    <input type="number" name="awayTeamGoals" id="awayTeamGoals" class="fw-admin-form-control">
                    @error('awayTeamGoals')
                        <div class="fw-admin-flash fw-admin-flash-error" style="margin-top:8px;">{{ $message }}</div>
                    @enderror
                </div>
