...
@section('title', 'Match Days')

@section('content')
    <div class="fw-admin-page-header">
        <div>
            <h1>Match Days</h1>
            <p>Manage match days for seasons.</p>
        </div>
        <a href="{{ route('add.day.season') }}" class="fw-admin-btn fw-admin-btn-primary"><i class="fas fa-plus"></i> Add day</a>
    </div>

    @include('partials.admin-list-filters', ['action' => route('day.season')])
    ...
    <div class="fw-admin-panel">
                ...
                <tbody>
                    @forelse($days as $item)
                        <tr>
                            ...
                            <td class="fw-admin-muted">{{ optional($item->creator)->name ?? '—' }}</td>
                            <td>
        ...
        @include('partials.admin-pagination', ['paginator' => $days])
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="deleteForm" action="{{ route('delete.day.season', 0) }}" method="POST">
                        @csrf
                        @method('DELETE')
