...
@section('content')
    <div class="fw-admin-page-header">
        <div>
            <h1>Partners</h1>
            <p>Manage federation partners.</p>
        </div>
    ...
    <div class="fw-admin-panel">
            ...
            <table class="fw-admin-table">
                ...
                <tbody>
                    @forelse($partners as $item)
                        <tr>
                            <td><img class="thumb" src="{{ route('partner.doc', $item['id']) }}" alt=""></td>
                            ...
                            <td>
                                <div class="fw-admin-actions">
                                    <a href="{{ route('partner.page.edit', $item['id']) }}" class="fw-admin-btn fw-admin-btn-secondary fw-admin-btn-sm">Edit</a>
        ...
        @include('partials.admin-pagination', ['paginator' => $partners])
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="deleteForm" action="{{ route('delete.partner', 0) }}" method="POST">
                        @csrf
                        @method('DELETE')
