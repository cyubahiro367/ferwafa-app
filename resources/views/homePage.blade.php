...
<head>
    ...
    <!-- Site libraries (Bootstrap 3 etc.) -->
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* ── TOP BAR ── */
    .fw-topbar { background: var(--blue); height: 36px; display: flex; align-items: center; }
    .fw-topbar-inner { display: flex; justify-content: space-between; align-items: center; width: 100%; padding: 0 32px; }
    ...
    .fw-nav-logo { display: flex; align-items: center; gap: 10px; text-decoration: none; flex-shrink: 0; }
    .fw-nav-logo-img {
      ...
      color: var(--white); letter-spacing: 1px; border: 2px solid var(--gold);
      overflow: hidden;
    }
    .fw-nav-logo-img img { width: 100%; height: 100%; object-fit: cover; }
    .fw-nav-logo-title { font-family: 'Oswald', sans-serif; font-size: 18px; font-weight: 700; color: var(--blue); line-height: 1; letter-spacing: 2px; }
    .fw-nav-logo-sub { font-size: 9px; color: var(--grey); letter-spacing: .5px; white-space: nowrap; }
    ...
    .fw-hamburger { display: none; flex-direction: column; gap: 5px; cursor: pointer; padding: 8px; background: none; border: none; justify-content: flex-end; }
    .fw-hamburger span { width: 24px; height: 2px; background: var(--text); display: block; }

    /* ── HERO SLIDER (custom JS, no Bootstrap carousel) ── */
    .fw-hero {
      position: relative;
    ...
    .fw-hero-actions { display: flex; gap: 12px; flex-wrap: wrap; }
    .fw-btn-gold {
      display: inline-flex; align-items: center; gap: 8px;
      background: var(--gold); color: var(--text);
    ...
    .fw-news-card-title {
      ...
      line-height: 1.3; text-transform: uppercase; color: var(--text); margin-bottom: 10px;
    }
    ...
    .fw-news-list-title {
      ...
      line-height: 1.3; text-transform: uppercase; color: var(--text);
    }
    ...
    .fw-comp-icon {
      ...
      background: rgba(245,168,0,0.15); border: 2px solid rgba(245,168,0,0.4);
    ...
    .fw-team-card-header {
      background: var(--blue); padding: 28px 20px;
    ...
    .fw-team-badge {
      ...
      color: var(--blue); text-align: center; border: 3px solid var(--gold);
    }
    ...
    .fw-mobile-nav {
      ...
      background: var(--blue); z-index: 2000; overflow-y: auto; flex-direction: column;
    }
    .fw-mobile-nav.open { display: flex; }
    .fw-mobile-nav-header {
      display: flex; justify-content: space-between; align-items: center;
      padding: 16px 20px; border-bottom: 2px solid var(--gold);
      position: sticky; top: 0; background: var(--blue); z-index: 1;
    }
    .fw-mobile-close {
    ...
    .fw-mobile-close:hover { background: var(--gold); color: var(--text); }
    .fw-mobile-links { list-style: none; padding: 8px 0 40px; flex: 1; }
    .fw-mobile-links > li { border-bottom: 1px solid rgba(255,255,255,0.08); }
    .fw-mob-row { display: flex; align-items: center; justify-content: space-between; }
    .fw-mob-row > a { flex: 1; padding: 15px 20px; font-family: 'Oswald', sans-serif; font-size: 15px; font-weight: 500; text-transform: uppercase; color: var(--white); text-decoration: none; }
    .fw-mob-row > a:hover { color: var(--gold); }
    .fw-mob-toggle { padding: 15px 20px; background: transparent; border: none; color: rgba(255,255,255,0.6); font-size: 12px; cursor: pointer; transition: color .2s, transform .3s; }
    .fw-mob-toggle.open { transform: rotate(180deg); color: var(--gold); }
    .fw-mob-sub { list-style: none; display: none; background: rgba(0,0,0,0.2); }
    .fw-mob-sub.open { display: block; }
    .fw-mob-sub > li { border-top: 1px solid rgba(255,255,255,0.06); }
    .fw-mob-sub > li > a { display: block; padding: 12px 20px 12px 36px; font-size: 13px; color: rgba(255,255,255,0.85); text-decoration: none; transition: color .2s, padding-left .2s; }
    .fw-mob-sub > li > a:hover { color: var(--gold); padding-left: 42px; }
    .fw-mob-sub-row { display: flex; align-items: center; justify-content: space-between; }
    .fw-mob-sub-row > a { flex: 1; padding: 12px 20px 12px 36px; font-size: 13px; color: rgba(255,255,255,0.85); text-decoration: none; }
    .fw-mob-sub-row > a:hover { color: var(--gold); }
    .fw-mob-sub-toggle { padding: 12px 16px; background: transparent; border: none; color: rgba(255,255,255,0.5); font-size: 11px; cursor: pointer; transition: color .2s, transform .3s; }
    .fw-mob-sub-toggle.open { transform: rotate(180deg); color: var(--gold); }
    .fw-mob-subsub { list-style: none; display: none; background: rgba(0,0,0,0.15); }
    .fw-mob-subsub.open { display: block; }
    .fw-mob-subsub li a { display: block; padding: 10px 20px 10px 52px; font-size: 12px; color: rgba(255,255,255,0.7); text-decoration: none; border-top: 1px solid rgba(255,255,255,0.04); transition: color .2s; }
    .fw-mob-subsub li a:hover { color: var(--gold); }

    /* ── FOOTER (keep existing) ── */
    .footer-main { background: var(--blue); }
            ...
            <div style="display:flex;justify-content:center;">
                <ul class="fw-nav-links">
                    ...
                    <li class="fw-dropdown">
                        ...
                        <ul class="fw-dropdown-menu">
                            <li class="fw-sub-drop">
                                <a href="#">Men Football</a>
                                <ul class="fw-sub-drop-menu">
                                    <li><a href="#">BK Pro League</a></li>
                                    <li><a href="#">Second Division</a></li>
                                    <li><a href="#">Third Division</a></li>
                                </ul>
                            </li>
                            <li><a href="#">Peace Cup</a></li>
                            <li><a href="#">Other Cups</a></li>
                        </ul>
                    </li>
...
<div class="fw-mobile-nav" id="fwMobileNav">
    <div class="fw-mobile-nav-header">
        <div style="display:flex;align-items:center;gap:10px;">
            <img src="{{ asset('images/file.png') }}" alt="FERWAFA"
                 style="width:38px;height:38px;border-radius:50%;border:2px solid var(--gold);object-fit:cover;" />
            <span style="font-family:'Oswald',sans-serif;font-size:18px;font-weight:700;color:#fff;letter-spacing:2px;">FERWAFA</span>
        </div>
    ...
    <ul class="fw-mobile-links">
        ...
        <li>
            <div class="fw-mob-row">
                <a href="#">Women Football</a>
                <button class="fw-mob-toggle" data-target="mob-women"><i class="fas fa-chevron-down"></i></button>
            </div>
            <ul class="fw-mob-sub" id="mob-women">
                <li>
                    <div class="fw-mob-sub-row">
                        <a href="#">First Division</a>
                        <button class="fw-mob-sub-toggle" data-target="mob-w1st"><i class="fas fa-chevron-down"></i></button>
                    </div>
                    <ul class="fw-mob-subsub" id="mob-w1st">
                        <li><a href="#">Fixtures &amp; Results</a></li>
                        <li><a href="#">Standings</a></li>
                        <li><a href="#">Top Scorers</a></li>
                    </ul>
                ...
                <li>
                    <div class="fw-mob-sub-row">
                        <a href="#">National Team</a>
                        <button class="fw-mob-sub-toggle" data-target="mob-wnat"><i class="fas fa-chevron-down"></i></button>
                    </div>
        ...
        <li>
            <div class="fw-mob-row">
                ...
                <button class="fw-mob-toggle" data-target="mob-comp"><i class="fas fa-chevron-down"></i></button>
            </div>
            <ul class="fw-mob-sub" id="mob-comp">
                <li>
                    <div class="fw-mob-sub-row">
                        <a href="#">Men Football</a>
                        <button class="fw-mob-sub-toggle" data-target="mob-cmen"><i class="fas fa-chevron-down"></i></button>
                    </div>
                    <ul class="fw-mob-subsub" id="mob-cmen">
                        <li><a href="#">BK Pro League</a></li>
                        <li><a href="#">Second Division</a></li>
                        <li><a href="#">Third Division</a></li>
                    </ul>
        ...
        <li>
            <div class="fw-mob-row">
                ...
                <button class="fw-mob-toggle" data-target="mob-nat"><i class="fas fa-chevron-down"></i></button>
            </div>
            <ul class="fw-mob-sub" id="mob-nat">
                <li>
                    <div class="fw-mob-sub-row">
                        <a href="#">Men</a>
                        <button class="fw-mob-sub-toggle" data-target="mob-nmen"><i class="fas fa-chevron-down"></i></button>
                    </div>
                ...
                <li>
                    <div class="fw-mob-sub-row">
                        <a href="#">Women</a>
                        <button class="fw-mob-sub-toggle" data-target="mob-nwom"><i class="fas fa-chevron-down"></i></button>
                    </div>
        ...
        <li>
            <div class="fw-mob-row">
                <a href="#">Resources</a>
                <button class="fw-mob-toggle" data-target="mob-res"><i class="fas fa-chevron-down"></i></button>
            </div>
        ...
        <li>
            <div class="fw-mob-row">
                ...
                <button class="fw-mob-toggle" data-target="mob-dev"><i class="fas fa-chevron-down"></i></button>
            </div>
        ...
        <li>
            <div class="fw-mob-row">
                <a href="#">Career</a>
                <button class="fw-mob-toggle" data-target="mob-car"><i class="fas fa-chevron-down"></i></button>
            </div>
...
{{-- ── HERO SLIDER (custom CSS/JS — not Bootstrap carousel) ── --}}
            ...
            @if ($topResult['is_top'] == 1)
                <div class="fw-hero-slide {{ $si === 0 ? 'active' : '' }}">
                    <div class="fw-hero-bg"
                         style="background-image:url('{{ route('news.images.show', $topResult['image_url']) }}')">
                    </div>
                    <div class="fw-wrap fw-hero-content">
                        <div class="fw-hero-inner">
                            ...
                            <div class="fw-hero-actions">
                                <a href="{{ route('single.news', $topResult['id']) }}" class="fw-btn-gold">
                                    <i class="fas fa-arrow-right"></i> Read More
                                </a>
                                <a href="{{ route('all.news') }}" class="fw-btn-ghost">
...
<div class="fw-section" style="background:#fff;">
    <div class="fw-wrap">
        <div class="fw-section-head">
            ...
            <a href="{{ route('all.news') }}" class="fw-view-all">
                ...
                <div class="fw-news-featured">
                    <a href="{{ route('single.news', $result[0]['id']) }}" class="fw-news-card">
                        <div class="fw-news-card-img">
                            <img src="{{ route('news.images.show', $result[0]['image_url']) }}"
                                 alt="{{ $result[0]['title'] }}" loading="lazy" />
                            <span class="fw-news-card-cat">News</span>
                        </div>
                        <div class="fw-news-card-body">
                            <div class="fw-news-card-meta">
                                <i class="far fa-calendar"></i>
                                {{ date('jS M Y', strtotime($result[0]['created_at'])) }}
                            </div>
        ...
        <div style="text-align:center; margin-top:44px;">
            <a href="{{ route('all.news') }}" class="fw-view-all"
               style="font-size:14px;padding:13px 30px;border:2px solid var(--blue);border-radius:var(--radius);display:inline-flex;align-items:center;gap:8px;">
...
<section class="fw-section fw-teams-section">
    <div class="fw-wrap">
        <div class="fw-section-head">
            <div>
                <div class="fw-section-label">Rwanda's Pride</div>
                <h2 class="fw-section-title">National Teams</h2>
            </div>
        ...
        <div class="fw-teams-grid">
            <a href="{{ route('seniorMen.news') }}" class="fw-team-card">
                <div class="fw-team-card-header">
                    <div class="fw-team-badge">AMAVUBI<br>STARS</div>
                    <div class="fw-team-flag"><span style="background:#00A1DE;"></span><span style="background:#FAD201;"></span><span style="background:#20603D;"></span></div>
                </div>
                <div class="fw-team-card-body">
                    <div class="fw-team-name">Senior Men – Amavubi</div>
                    <div class="fw-team-desc">Rwanda's senior men's team competing in AFCON qualifiers and CAF competitions.</div>
                    <span class="fw-team-link">View Team <i class="fas fa-arrow-right"></i></span>
                </div>
            </a>
            <a href="{{ route('seniorWomen.news') }}" class="fw-team-card">
                <div class="fw-team-card-header">
                    <div class="fw-team-badge">SENIOR<br>WOMEN</div>
                    <div class="fw-team-flag"><span style="background:#00A1DE;"></span><span style="background:#FAD201;"></span><span style="background:#20603D;"></span></div>
                </div>
                <div class="fw-team-card-body">
                    <div class="fw-team-name">Senior Women</div>
                    <div class="fw-team-desc">Rwanda's senior women's team competing in WAFCON qualifiers and growing the women's game.</div>
                    <span class="fw-team-link">View Team <i class="fas fa-arrow-right"></i></span>
                </div>
            </a>
            <a href="{{ route('u17.news') }}" class="fw-team-card">
                <div class="fw-team-card-header">
                    <div class="fw-team-badge">YOUTH<br>TEAMS</div>
                    <div class="fw-team-flag"><span style="background:#00A1DE;"></span><span style="background:#FAD201;"></span><span style="background:#20603D;"></span></div>
                </div>
                <div class="fw-team-card-body">
                    <div class="fw-team-name">Youth Teams</div>
                    <div class="fw-team-desc">U-17, U-20 &amp; U-23 squads representing Rwanda's next generation of football talent.</div>
                    <span class="fw-team-link">View Teams <i class="fas fa-arrow-right"></i></span>
                </div>
            </a>
        </div>
    </div>
...
{{-- ── PARTNERS (original asset paths) ── --}}
<div class="fw-partners">
    <div class="fw-wrap">
        <p class="fw-partners-label">Our Partners &amp; Affiliates</p>
        <div class="fw-partners-row">
            <a href="https://www.minisports.gov.rw/" target="_blank" class="fw-partner-logo">
                <img src="{{ asset('images/images.jpeg') }}" alt="MINISPORTS" />
            </a>
            <a href="https://www.cafonline.com/" target="_blank" class="fw-partner-logo">
                <img src="../asset/images/pngtree-caf-football-logo-png-image_3643068.jpg" alt="CAF" />
            </a>
            <a href="https://olympicrwanda.org/" target="_blank" class="fw-partner-logo">
                <img src="{{ asset('images/Logo Institu CNOSR sans fond.png') }}" alt="Rwanda Olympics" />
            </a>
            <a href="https://bralirwa.co.rw/" target="_blank" class="fw-partner-logo">
                <img src="../asset/images/primus.jpg" alt="Primus" />
            </a>
            <a href="https://www.fifa.com/fifaplus/en" target="_blank" class="fw-partner-logo">
                <img src="{{ asset('images/fifa.png') }}" alt="FIFA" />
            </a>
        </div>
    </div>
</div>
...
<script>
    // ── Custom hero slider (no Bootstrap carousel) ──────────────────
