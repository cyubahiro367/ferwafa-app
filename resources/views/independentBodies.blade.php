...
<div>
    ...
    <div class="container-fluid no-padding team-section">
        ...
        <div class="section-header">
            <h3>Meet our great {{ $title }} Committee Members</h3>
            <span>{{ $title }} Committee</span>
        </div>
        <ul id="team-carousel">
    ...
    <div class="container">
        <div class="row contact-form-section">
          <div class="col-md-12 col-sm-12">
            ...
            <form method="POST" action="{{ route('independent.message') }}"  enctype="multipart/form-data" id="contact-form" class="contactus-form">
              @csrf
              <input
                    type="hidden"
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <label class="col-form-label text-md-right col-12 col-md-12 col-lg-12">add supporting document</label>
                    <div class="form-group">
